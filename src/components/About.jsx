    ...
    <section id="about" className="bg-gray-100 py-16 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-600 leading-relaxed text-lg">
          ...
          a passionate Full Stack Developer currently pursuing BTech in Computer Science and Engineering.  
          I enjoy building responsive web applications using modern technologies like 
          <span className="font-medium"> React.js, Node.js, and MongoDB</span>.  
          I am interested in software development, problem-solving, and creating user-friendly applications that solve real-world problems.
        </p>
